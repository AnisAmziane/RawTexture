...
### ------------------------------------------------------------------
illuminant_solar = np.load('extended_solar_380_1000_interp1nm.npy')
_, idx_illu_for_hytexila = ST.find_closest_spectra_illuminant(HyTexila_centers,illuminant_solar[:,0])
selected_solar_values = illuminant_solar[idx_illu_for_hytexila,1]
