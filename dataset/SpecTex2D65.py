# -*- coding: utf-8 -*-
""" Title: Convert SpecTex reflectance to radiance under extended D65 illuminant
...
### ------------------------------------------------------------------
illuminant_A = np.load('/.../utils/extended_A_380_1000_interp1nm.npy')
_, idx_illu_for_spectex = ST.find_closest_spectra_illuminant(Spectex_centers,illuminant_A[:,0])
selected_A_values = illuminant_A[idx_illu_for_spectex,1]
