...
CONFIG = SimpleNamespace(images_path = '/path to HyTexila_A_IMEC16_raw or HyTexila_Solar_IMEC16_raw/',
                         extracted_features_path='/features/',
                         model_save_path='/trained_models/',
                         model_name='RawMixerRes', input_channels=1, patch_size=(124,124),
                         MSFA='Imec16', msfa_width=4, logits_size=112, device=device)
#-----------------------------------------------------------------------------------------#
