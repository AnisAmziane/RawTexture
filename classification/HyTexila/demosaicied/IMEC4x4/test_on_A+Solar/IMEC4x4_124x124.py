...
CONFIG = SimpleNamespace(images_path = '/home/anis/Documents/ms_base/others/HyTexila_bmvc/HyTexila_Solar_IMEC16_demosaiced/',
                         model_save_path='/home/anis/PycharmProjects/RawTexture/venv/TextureExp/classification/exps/trained_models/',
                         model_name='ResNet18', input_channels=16, patch_size=(124,124), MSFA='Imec16', msfa_width=4,token_width=31, logits_size=112, device=device)
