...
for j in tqdm(range(steps)):
    data = np.asarray(list_test_labels[i * batch_size:(i + 1) * batch_size])
    ...
    # free some memory
    del data, list_test_labels[i * batch_size:(i + 1) * batch_size], list_test_features_lcc, list_train_test_ppi
    gc.collect()
