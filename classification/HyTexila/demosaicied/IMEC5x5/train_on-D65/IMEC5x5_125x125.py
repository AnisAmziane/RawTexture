...
CONFIG = SimpleNamespace(images_path = '/home/anis/Documents/ms_base/others/HyTexila_bmvc/HyTexila_D65_IMEC25_demosaiced/',
                         ...
                         model_name='Vision_Conformer', input_channels=25, patch_size=(125,125),MSFA='Imec25',msfa_width=5, token_width=25, logits_size=112, device=device)
#-----------------------------------------------------------------------------------------#
...
for model_name in ['SpectralFormer_CAF','ResNet18','hsi_mixer']:
    gc.collect()
    torch.cuda.empty_cache()
