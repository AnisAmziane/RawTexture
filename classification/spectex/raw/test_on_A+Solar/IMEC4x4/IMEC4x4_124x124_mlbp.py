...
#-----------------------------------------------------------------------------------------#
CONFIG = SimpleNamespace(images_path = '/path to Spectex_Solar_IMEC16_raw/',
                         extracted_features_path = '',
                         model_name='MLBP', input_channels=1, patch_size=(124,124),
                         MSFA='Imec16', logits_size=112, device='cpu')
#-----------------------------------------------------------------------------------------#
...
list_test_labels = np.asarray(list_test_labels)
# Load train features
list_train_features = np.load(CONFIG.extracted_features_path+CONFIG.model_name+'_'+CONFIG.MSFA+'_'+str(CONFIG.patch_size[0])+'x'+str(CONFIG.patch_size[1])+'_features_spectex.npy')
list_train_labels = np.load(CONFIG.extracted_features_path+CONFIG.model_name+'_'+CONFIG.MSFA+'_'+str(CONFIG.patch_size[0])+'x'+str(CONFIG.patch_size[1])+'_labels_spectex.npy')
###
