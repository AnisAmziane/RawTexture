...
""" Code source forked from: https://github.com/SHI-Labs/Compact-Transformers/tree/main/src """
...
def _cct(img_size, input_channels ,num_layers, num_heads, mlp_ratio, embedding_dim,
         num_classes=4,kernel_size=3, stride=None, padding=None):
